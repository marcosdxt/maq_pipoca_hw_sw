...
//----------------------------------------------------------------------------------
  ...
  #define STR_VERSAO_BOARD      "     1.10.4-BR  "
#endif

#ifdef _URUGUAI_
  #define FQ_REDE_50_HZ
  #define ESPANHOL
  #define STR_VERSAO_BOARD      "     1.10.4-UY  "
#endif

#ifdef _PARAGUAI_
  #define FQ_REDE_50_HZ
  #define ESPANHOL
  #define STR_VERSAO_BOARD      "     1.10.4-PY  "
#endif

#ifdef _PARAGUAI_60HZ_
  #define FQ_REDE_60_HZ
  #define ESPANHOL
  #define STR_VERSAO_BOARD      "  1.10.4-PYBR   "
#endif

#ifdef _URUGUAI_60HZ_
  #define FQ_REDE_50_HZ
  #define ESPANHOL
  #define STR_VERSAO_BOARD      "  1.10.4-UYBR   "
#endif
//----------------------------------------------------------------------------------
