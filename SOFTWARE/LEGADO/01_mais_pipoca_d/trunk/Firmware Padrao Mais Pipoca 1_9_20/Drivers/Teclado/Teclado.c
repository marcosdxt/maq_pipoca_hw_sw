...
#define TECLA_INC_PIN                   (0x01)<<10
#define TECLA_DEC_PIN                   (0x01)<<9
#define TECLA_ENTER_PIN                 (0x01)<<14
#define TECLA_GRATIS_PIN                (0x01)<<29        
...
#define GET_TECLA_GRATIS()              (FIO1PIN&TECLA_GRATIS_PIN)?0:16
#define GET_FIM_PAPEL()                 (FIO1PIN&CHAVE_FIM_PAPEL)?64:0
#define GET_PORTA_ABERTA()              (FIO1PIN&CHAVE_PORTA_ABERTA)?32:0
...
void TECLADO_timerTick(void){
  ...
  if(ciclos)
    ...
    TECLADO_bufferAmostragem[indice] |= GET_FIM_PAPEL();
    TECLADO_bufferAmostragem[indice] |= GET_PORTA_ABERTA();
