...
unsigned char MP_lockCoin=0;
unsigned char MP_bloqueioMoedeiro=0;
...
void MP_main(void*pPar){
  ...
  for(;;){
    ...
    if(PARAMETROS_leTipoNoteiro()==BV20)// Só executa a máquina de estados 
      MP_bv20FSM();
    else
