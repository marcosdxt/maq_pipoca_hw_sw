...
*       Constantes
***********************************************************************************/
 const unsigned int numeroSerie=231;
...
void IU_enviaTelemetria(void){
  ...
  IU_estadoConexaoTelemetria = TELET_escreveBlocoOperacao(numeroSerie,PARAMETROS_leContadorVendas(),PARAMETROS_leContadorArrecadacao(),PARAMETROS_leTotalizadorPermanente(),flags,0); 
}
/***********************************************************************************
