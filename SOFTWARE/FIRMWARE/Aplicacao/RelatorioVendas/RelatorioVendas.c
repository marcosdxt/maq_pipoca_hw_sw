...
*       Funções locais
***********************************************************************************/
extern unsigned int IU_getNumeroSerie(void);
...
void RV_relatorioPonto(void){
  ...
  //IMPRESSORA_dobra_fonte();
  IMPRESSORA_enviaLinhas((char**)cabecalho,6);   
  //IMPRESSORA_fonte_tamanho_normal();
  ...
  unsigned int cartao = PARAMETROS_carregaFaturamentoParcialCartao();
  bufferTexto[0] = ((cartao/100000)%10) + '0';
  bufferTexto[1] = ((cartao/10000)%10) + '0';
  bufferTexto[2] = ((cartao/1000)%10) + '0';
  bufferTexto[3] = ((cartao/100)%10) + '0';
  bufferTexto[4] = ((cartao/10)%10) + '0';
  bufferTexto[5] = ((cartao%10)) + '0';
  bufferTexto[6] = ',';
  bufferTexto[7] = '0';
  bufferTexto[8] = '0';
  bufferTexto[9] = '\0';
  
  IMPRESSORA_enviaLinhas((char**)TituloCartao,2);
  
  sprintf(linha,"Parcial:%s\n",bufferTexto);
  IMPRESSORA_enviaLinhas(pLinha,1);
  
  cartao = PARAMETROS_carregaFaturamentoTotalCartao();
  bufferTexto[0] = ((cartao/100000)%10) + '0';
  bufferTexto[1] = ((cartao/10000)%10) + '0';
  bufferTexto[2] = ((cartao/1000)%10) + '0';
  bufferTexto[3] = ((cartao/100)%10) + '0';
