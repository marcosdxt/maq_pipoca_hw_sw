...
/************************************************************************************
*       Descri��o       :       Desenha as op��es do menu de configura��o
*                               do sistema
*       Parametros      :       (unsigned char) indice da op��o
*       Retorno         :       nenhum
************************************************************************************/
void MCS_desenhaOpcoes(unsigned char indice){
...
/************************************************************************************
*       Descri��o       :       Menu com as op��es do menu para
*                               ajuste dos parametros de prepara��o da pipoca
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuParametrosPreparacao(void){
...
/************************************************************************************
*       Descri��o       :       Menu com as op��es do menu de configura��o
*                               da prepara��o
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar o tempo
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar o atraso
*                               entre iniciar a preparar a pipoca e 
*                               a libera��o do pacote
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configuraAtrasoPacote(void){
...
/************************************************************************************
*       Descri��o       :       Configura o valor da pipoca
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configuraValorPipoca(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio informar uma senha
...
/************************************************************************************
*       Descri��o       :       Tela para configura��o do beta do termistor
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaConfiguraBeta(void){
...
/************************************************************************************
*       Descri��o       :       Configura o rt do termistor
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaConfiguracaoRT(void){
...
/************************************************************************************
*       Descri��o       :       Tela para configura��o das c�dulas que 
*                               ser�o aceitas pelo noteiro
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaConfiguraTipoCedulas(void){
...
/************************************************************************************
*       Descri��o       :       Desenha as op��es das c�dulas
*       Parametros      :       (unsigned char) indice
*                               (unsigned char) flag
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio gerar a senha
*                               de pipoca gr�tis
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Ponto de entrada do menu de visualiza��o
*                               da arrecadacao
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuArrecadacao(void){
  ...
  if(!MCS_telaSenha(SENHA_FATURAMENTO/*4790*/))
    return;
...
/************************************************************************************
*       Descri��o       :       Desenha os textos do menu de arrecada��o
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
void MCS_desenhaOpcoesArrecadacao(unsigned char indice){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio realizar a visualiza��o
*                               do totalizador 
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio realizar o zeramento
...
void MCS_telaZeraContadorArrecadacao(void){
  ...
  if(MCS_telaSenha(SENHA_ZERAR_FAT_PARCIAL/*1530*/)){
...
/************************************************************************************
*       Descri��o       :       Tela para exibi��o do total permanente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaExibeTotalPermanente(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar o intervalo
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar se a fita
*                               led pisca ou n�o enquanto a m�quina est� em 
*                               stand by
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio configurar a temperatura
*                               de pr�-processo
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para a visualiza��o dos totalizadores
*                               de dinheiro
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuLeiturista(void){
  ...
  if(MCS_telaSenha(SENHA_MENU_LEITURISTA/*2530*/)){
    MCS_menuArrecadacao();        
  }
  HD44780_clearText();  
}
/************************************************************************************
*       Descri��o       :       Configura a velocidade inicial
*                               da expuls�o das pipocas
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuConfiguraVelocidadeExpulsaoPipocas(void){
...
/************************************************************************************
*       Descri��o       :       Configura a velocidade final da expuls�o
*                               das pipocas
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para configurar o volume do som
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_volumeSom(void){
...
/************************************************************************************
*       Descri��o       :       Menu para teste do hardware
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuTesteHardware(void){
...
/************************************************************************************
*       Descri��o       :       Desenha o menu para o teste do hardware
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
void MCS_desenhaOpcoesHardware(unsigned char indice){
...
/************************************************************************************
*       Descri��o       :       Tela para exibi��o da leitura do sensor
*                               de temperatura
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para exibi��o da leitura do sensor de papel
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaTesteSensorPapel(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o teste do sensor de dose
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testeSensorDose(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste do sensor de rota��o do motor
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testeRotacaoMotor(void){
  ...
  HD44780_clearText();
  //                   123456789123456
  HD44780_writeString("  Teste Motor  ");
  ...
  for(;;){
    ...
    if(!BOARD_tempoPiscadas)
      if(rotacao!=ultimaRotacao && flag){
        MU_setRPM(rotacao);
        ultimaRotacao = rotacao;
      }
    
    sprintf(bufferLinha," [%05d][%s] ",BOARD_tempoPiscadas?rotacao:MU_getRPMmedido(),flag?"ON":"OFF");
...
/************************************************************************************
*       Descri��o       :       Tela para verificar a frequ�ncia da rede el�trica
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_teste60Hz(void){
...
/************************************************************************************
*       Descri��o       :       Teste do motor da embalagem
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testeMotorEmbalagem(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste do moedeiro
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testeMoedeiro(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste da sa�da de audio
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaTesteAudio(void){
...
/************************************************************************************
*       Descri��o       :       Tela de teste para as sa�das de led
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaTesteFitaLed(void){
...
/************************************************************************************
*       Descri��o       :       Menu para configura��o do par�metro
*                               volume da voz
*       Parametros      :       nenhmn
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Menu para configura��o da fita de led
...
/************************************************************************************
*       Descri��o       :       Tela para configura��o da comiss�o do ponto
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaConfiguracaoComissaoPonto(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste do sinal da chave de fim do
*                               papel
*       Parametros      :       (nenhum)
*       Retorno         :       (nenhum)
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para o teste do sinal de porta aberta
*       Parametros      :       (nenhum)
*       Retorno         :       (nenhum)
************************************************************************************/
void MCS_telaTesteChavePorta(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste da comunica��o com o m�dulo
*                               de telemetria
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :      Tela para teste do led de gr�tis
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaTesteSaidaLedGratis(void){
...
/************************************************************************************
*       Descri��o       :       Tela para teste do controle de angulo de fase
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testaTesteAnguloFase(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar a m�quina com
*                               o padr�o de f�brica
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configuracaoFabrica(void){ 
   ...
   if(!MCS_telaSenha(/*3214*/SENHA_CONFIG_FABRICA)){
    HD44780_clearText();
    return;
  }
...
/************************************************************************************
*       Descri��o       :       Tela para teste da reprodu��o das vozes
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaTesteVoz(void){
...
/************************************************************************************
*       Descri��o       :       Tela para capturar as configura��es de f�brica
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaCapturaConfigFabrica(void){

  if(!MCS_telaSenha(/*3215*/SENHA_CAPTURA_CONFIG_FABRICA)){
    HD44780_clearText();
    return;
  }    
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio cadastrar a op��o
*                               de loca��o da m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaOpcaoLocacao(void){
  ...
  if(!MCS_telaSenha(/*4991*/SENHA_LOCACAO)){
    HD44780_clearText();
    return;
  }    
...
/************************************************************************************
*       Descri��o       :       Interface para fazer o zeramento dos
*                               totalizadores
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para configura��o do par�metro de temperatura
*                               inicial de preparo
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio cadastrar
*                               o tempo de pr�-aquecimento
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configuraTempoPreAquecimento(void){
...
/************************************************************************************
*       Descri��o       :       Menu para cadastrar a mensagem de cliente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configMensagemCliente(unsigned char index){
...
/************************************************************************************
*       Descri��o       :       Cadastra a primeira mensagem de cliente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_cadastraMensagem_01(void){
...
/************************************************************************************
*       Descri��o       :       Cadastra a segunda mensagem de cliente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_cadastraMensagem_02(void){
...
/************************************************************************************
*       Descri��o       :       Cadastra a terceira mensagem de cliente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_cadastraMensagem_03(void){
...
/************************************************************************************
*       Descri��o       :       Cadastra a quarta mensagem de cliente
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_cadastraMensagem_04(void){
...
/************************************************************************************
*       Descri��o       :       Tela para configurar a velocidade que ser�
*                               utilizada na autodesumidifica��o
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_configuraVelocidadeDesumificador(void){
...
/************************************************************************************
*       Descri��o       :       Tela para configurar a temperatura de desumificador
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_cadastraTemperaturaDesumificacao(void){
...
/************************************************************************************
*       Descri��o       :       Faz a assinatura do sistema
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para visualiza��o da contagem
*                               do hor�metro
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio inserir a senha
*                               de libera��o do hor�metro
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_liberacaoHorimetro(void){
...
/************************************************************************************
*       Descri��o       :       Menu para realizar o acerto nos totalizadores
*                               do sistema
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Desenha as op��es do menu de ajuste
*                               dos contadores
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para fazer o ajuste do contador de unidades
*                               vendidas parcial
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para fazer o ajuste do contador de 
...
/************************************************************************************
*       Descri��o       :       Tela para fazer o ajuste do contador
*                               de arrecada��o parcial
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_ajustaArrecadacaoParcial(void){
...
/************************************************************************************
*       Descri��o       :       Tela gen�rica para o usu�rio digitar
...
/************************************************************************************
*       Descri��o       :       Faz a verifica��o da contrasenha
*                               de seguran�a
*       Parametros      :       nenhum
...
/************************************************************************************
*       Descri��o       :       Tela para exibir a quantidade parcial
*                               de pipocas vendidas
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para exibir a quantidade total de 
*                               pipocas vendidas
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Exibe o SSID configurado para a rede wifi
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuExibeSSID(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio alterar o SSID
*                               da rede
*       Parametros      :       nenhum
*       Retorno         :       nenhm
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Salva os dados do SSID na mem�ria do m�dulo
*                               Wifi
...
/************************************************************************************
*       Descri��o       :       Remove os espa�os ap�s o final da string
...
/************************************************************************************
*       Descri��o       :       Tela para excluir o SSID configurado
*                               para a m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para visualizar a senha da rede wifi
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuVisualizaSenhaWiFi(void){
...
/************************************************************************************
*       Descri��o       :       Tela para visualizar o MAC Address
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuVisualizaMACAddress(void){
...
/************************************************************************************
*       Descri��o       :       Tela para visualizar o MAC Telemetria
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuVisualizaMACTelemetria(void){
...
/************************************************************************************
*       Descri��o       :       Tela para realizar a edi��o da senha da
*                               rede wifi
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para salvar a senha wifi no m�dulo
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaSalvaSenhaWiFi(char *senha){
...
/************************************************************************************
*       Descri��o       :       Apaga a senha da rede wifi
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_apagaSenhaWifi(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar qual noteiro
*                               ser� utilizado pela m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_selecionaTipoNoteiro(void){
...
/************************************************************************************
*       Descri��o       :       Configura o modelo da impressora utilizada
*                               para a leitura da arrecada��o da m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuConfiguraImpressora(void){
...
/************************************************************************************
*       Descri��o       :       Tela para visualiza��o das 
*                               vendas realizadas com o cart�o de cr�dito
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_telaVendasCartao(void){
...
/************************************************************************************
*       Descri��o       :       Tela para o usu�rio configurar o tipo
*                               do moedeiro que ser� utilizado
*                               na m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/***********************************************************************************
*       Descri��o       :       Escreve os valores do rtc no displays
...
/***********************************************************************************
*       Descri��o       :       Interface para ajuste do rel�gio
*       Parametros      :       nenhum
*       Retorno         :       nenhum
***********************************************************************************/
void MCS_ajusteRelogio(void){
...
/************************************************************************************
*       Descri��o       :       Interface para teste do RTC
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_testeRTC(void){
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio cadastrar o numero
*                               de s�rie da m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Desenha as op��es do menu de exibi��o
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Menu com as op��es de exibi��o 
*                               da m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Desenha as op��es do menu de opera��o
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Menu com as op��es de opera��o
*                               da m�quina
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Menu com as op��es da telemetria
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuTelemetria(void){
...
/************************************************************************************
*       Descri��o       :       Desenha as op��es do menu para configura��o
*                               do desumidificador
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Menu para configura��o dos perif�ricos da m�quina
*       parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menuConfiguraPerifericos(void){
...
/************************************************************************************
*       Descri��o       :       Desenha os dados do menu avan�ado na tela
*       Parametros      :       (unsigned char) indice
*       Retorno         :       nenhum
************************************************************************************/
void MCS_desenhaOpcoesAvancado(unsigned char indice){
...
/************************************************************************************
*       Descri��o       :       Menu para teste/configura��o do volume
*                               da m�sica
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Interface para o usu�rio configurar o volume
*                               da voz
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para cadastrar o tempo de desligamento
...
/************************************************************************************
*       Descri��o       :       Menu para exibi��o dos dados de faturamento
...
/************************************************************************************
*       Descri��o       :       Teste das sa�das de coletor aberto utilizadas
...
************************************************************************************/
void MCS_cadastraSenhas(void){
  unsigned short int senhas[2]; 
  
  if(MCS_telaSenha(PARAMETROS_leSenhaRoot())){
    
    senhas[0] = MCS_digitaSenha("Nova senha");
    senhas[1] = MCS_digitaSenha("Confirmacao");
    
    if(senhas[0]==senhas[1]){
      PARAMETROS_gravaSenhaRoot(senhas[0]);
      HD44780_clearText();
      HD44780_writeString("Alterado com");
      HD44780_posicionaTexto(0,1);
      HD44780_writeString("sucesso");
      vTaskDelay(3000);      
    }
      ...
      HD44780_clearText();
      HD44780_writeString("Senhas");
      HD44780_posicionaTexto(0,1);
      HD44780_writeString("diferentes");
      vTaskDelay(3000);      
    }
  }  
}
...
/************************************************************************************
*       Descri��o       :       Tela para reiniar a senha de administrador
*                               com zeros
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela para realizar o reset da senha mestre
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_tela_reset_master(void){
...
/************************************************************************************
*       Descri��o       :       Menu para configura��o do valor do cr�dito
*                               do moedeiro UCA-1
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Tela de configura��o de um valor inteiro
...
/************************************************************************************
*       Descri��o       :       Configura o ganho KP do controlador PID do 
*                               motor
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
...
/************************************************************************************
*       Descri��o       :       Configura o ganho KI do controlador PID
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_tela_configura_I(void){
...
/************************************************************************************
*       Descri��o       :       Configura o ganho KD do controlador PID
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_tela_configura_D(void){
...
/************************************************************************************
*       Descri��o       :       Desenha o fundo do menu de ajuste do PID
...
/************************************************************************************
*       Descri��o       :       Menu para configura��o dos ganhos do PID
*       Parametros      :       nenhum
*       Retorno         :       nenhum
************************************************************************************/
void MCS_menu_configura_ganhos(void){
