...
;
	...
	EXTERN vPortSVCHandler
        ...
        EXTERN UART_irq_uart_0;
        EXTERN UART_irq_uart_1;
        EXTERN UART_irq_uart_2;
        EXTERN UART_irq_uart_3;
        EXTERN MU_eintInterrupt;
        EXTERN MU_captureInterrupt;
        EXTERN MU_mathTimer2;
        EXTERN CCTALK_irqUart;
        EXTERN PROTOCOLO_intVect;
        EXTERN PLAYRWAVE_rti;
        EXTERN TELET_vetor_interrupcao;
        EXTERN MP_gpioInt;
...
__vector_table_0x1c
        ...
        DCD     MU_captureInterrupt          ; TIMER1 Handler
        DCD     MU_mathTimer2                ; DECODIFICADOR_interruptCAP_2 ; TIMER2 Handler
        DCD     TMR3_IRQHandler              ; TIMER3 Handler        
        DCD     CCTALK_irqUart               ; UART0_IRQHandler            ; UART0 Handler
        DCD     TELET_vetor_interrupcao      ; 0                           ; UART1_IRQHandler            ; UART1 Handler
        DCD     0; UART_irq_uart_2           ; UART2_IRQHandler            ; UART2 Handler
        DCD     PROTOCOLO_intVect            ; UART3_IRQHandler            ; UART3 Handler        
        ...
        DCD     MU_eintInterrupt             ; EINT1_IRQHandler            ; EXT Interupt 1 Handler
        DCD     EINT2_IRQHandler             ; EXT Interupt 2 Handler
        DCD     MP_gpioInt                   ; EXT Interupt 3 Handler
